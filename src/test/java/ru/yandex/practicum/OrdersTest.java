...
public class OrdersTest {
    ...
    public void getOrders() {
        log.info("Запрос на получение списка заказов отправлен.");
        ...
        log.info("Ответ на запрос на получение списка заказов обработан успешно. Код ответа: {}.", response.getStatusCode());
    }
}
