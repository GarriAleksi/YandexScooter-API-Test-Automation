...
public class LoginTest extends BaseTest {
    ...
    public void courierWithPasswordEmpty() {
        CourierForAuth courierForAuthWithEmptyPassword = generator.getCourierForAuthWithPasswordEmpty(courier);
        log.info(COURIER_AUTHORIZATION, courierForAuthWithEmptyPassword);

        Response response = courierClient.login(courierForAuthWithEmptyPassword);
        log.info(RESPONSE + "\n", response.body().asString());
